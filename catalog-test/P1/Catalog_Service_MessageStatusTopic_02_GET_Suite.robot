...
*** Test cases ***
Catalog_Service_01_GET verify successful operation of GET ALL Message Status Topic Details
    [Documentation]    This test is to verify successful GET operation in retrieving the stored Message Status Topic Details
    ...    from DB(postgreSQL)
    [Tags]    GET Request
...
Catalog_Service_02_GET verify successful operation of GET Message Status Topic Details using queryParams(messageBusId & name)
    [Documentation]    This test is to verify successful GET operation in retrieving the stored Message Status Topic Details
...
Catalog_Service_03_GET verify successful operation of GET Message Status Topic Details using PathVariable (id)
    [Documentation]    This test is to verify successful GET operation in retrieving the stored Message Status Topic Details
